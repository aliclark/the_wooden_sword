...
- I firstly propose that, philosophically, the basis for qualia is existence itself, [from metaphysical axiom](Nothing%20is%20a%20Contradiction.md). I approximately adhere to Priority Cosmopsychism where the basic consciousness is existence itself and the protophenomenal is also existence itself (not merely a property).
